...
ActiveRecord::Schema.define(version: 20170905150635) do
  ...
  create_table "recommendation_documents", force: :cascade do |t|
    ...
    t.jsonb "static_tags", default: {}
    t.jsonb "tags_cache", default: {}
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recommendable_id", "recommendable_type"], name: "index_recommendation_documents_on_recommendable"
